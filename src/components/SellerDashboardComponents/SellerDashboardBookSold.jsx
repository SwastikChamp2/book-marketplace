...
import BookSoldCardSeller from '../BookSoldCard/BookSoldCardSeller';

const SellerDashboardBookSold = () => {
    ...
    useEffect(() => {
        const fetchBookSoldList = async () => {
            try {
                const q = query(collection(db, 'PurchasedBooks'), where('bookseller', '==', auth.currentUser.email));
...
export default SellerDashboardBookSold;
